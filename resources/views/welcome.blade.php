...
<div class="hero-content-wrap flex flex-column justify-content-center align-items-start">
    <header class="entry-header">
        <h4>Atrévete a Iniciar tu Viaje por la Selva</h4>
            <h1>Aventuras Travel<br/>Tu Mejor opción!!!</h1>
    </header><!-- .entry-header -->
    <div class="entry-content">
     <p>Hacemos que tu viaje se convierta en una experiencia inolvidable; "Porque casa viaje es una Aventura... DISFRÚTALO." Ven y deleitate de lo profundo de la selva, te ofrecemos multiples alternativas durante tu estancia en la aquí.</p>
    </div><!-- .entry-content -->

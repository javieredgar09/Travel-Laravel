...
<div class="container" style="padding-top:200px ; padding-bottom:100px">
	<div class="d-flex justify-content-center h-100">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Confirma tu contraseña">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
        ...
        <div class="col-md-8 offset-md-4">
            <div class="form-group">
				<input type="submit" value="Guardar" class="btn float-right login_btn">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-5 col-form-label text-md-right text-success"><b>{{ __('Contraseña') }}</b></label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-5 col-form-label text-md-right text-success"><b>{{ __('Confirmar Contraseña') }}</b></label>
